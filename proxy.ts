...
export const config = {
  matcher: [
    ...
    "/login",
    "/register",
    // استثنا برای مسیرهای auth تا در حلقه نیفتند
    "/((?!_next/static|_next/image|favicon.ico|sitemap.xml|robots.txt|fonts|api/auth).*)",
  ],
};
